...
\begin{figure*}[h]
    ...
    \begin{subfigure}{\textwidth}
          \includegraphics[width=\textwidth]{/ols_coefs_partial_ageless_nosq.pdf}
  		\caption{Models 1-4} 
			\label{fig:ols_partial_nosq}
       \end{subfigure}
      \begin{subfigure}{\textwidth}
          \includegraphics[width=\textwidth]{fanfic/figs/ols_coefs_partial_ageless.pdf}
		\caption{Models 5-8} 
...
\begin{figure*}
    \centering
          \includegraphics[width=\textwidth]{fanfic/figs/ols_coefs_full_ageless.pdf}
